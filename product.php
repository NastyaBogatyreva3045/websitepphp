...
<main class="page-product container">
  ...
  <section class="product-photos">
    ...
    <img class="product-photo-full" src="img\img\main photo.jpg" width="460" height="498" alt="Фото всего набора">
    <ul class="product-photo-preview">
      <li>
        <img src="img\photo 7.png" width="140" height="149" alt="анфас">
      </li>
      <li>
        <img src="img\photo 8.png" width="140" height="149" alt="профиль">
      </li>
      <li>
        <img src="img\photo 9.png" width="140" height="149" alt="Фото отдельной части">
      </li>
    </ul>
  </section>
