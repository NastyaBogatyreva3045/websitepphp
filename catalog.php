...
<header class="main-header">
  <nav class="main-navigation container">
    <a class="main-header-logo" href="catalog.php">
      <img src="img\img\Vector-2.svg" width="111" height="24" alt="Логотип барбершопа «Бородинский»">
    </a>
    ...
    <ul class="catalog-list">
      <li class="catalog-item">
        <a href="product.html">
          ...
          <img class="catalog-item-image" src="img\img\photo-5.jpg" width="220" height="165" alt="Набор для путешествий «Baxter of California»">
        </a>
      ...
      <li class="catalog-item">
        <a href="product.php">
          ...
          <img class="catalog-item-image" src="img\img\photo-4.jpg" width="220" height="165" alt="Увлажняющий кондиционер «Baxter of California»">
        </a>
        <p class="catalog-item-price">
          <b>750 ₽</b>
      ...
      <li class="catalog-item">
        <a href="product.php">
          ...
          <img class="catalog-item-image" src="img\img\photo-3.jpg" width="220" height="165" alt="Гель для волос «Suavecito»">
        </a>
        <p class="catalog-item-price">
          <b>290 ₽</b>
          <button class="button" type="button">Купить</button>
      ...
      <li class="catalog-item">
        <a href="product.php">
          ...
          <img class="catalog-item-image" src="img\img\photo-2.jpg" width="220" height="165" alt="Глина для укладки волос «American crew»">
        </a>
        <p class="catalog-item-price">
          <b>500 ₽</b>
          <button class="button" type="button">Купить</button>
      ...
      <li class="catalog-item">
        <a href="product.php">
          ...
          <img class="catalog-item-image" src="img\img\photo-1.jpg" width="220" height="165" alt="Гель для волос «American crew»">
        </a>
        <p class="catalog-item-price">
          <b>300 ₽</b>
          <button class="button" type="button">Купить</button>
      ...
      <li class="catalog-item">
        <a href="product.php">
          ...
          <img class="catalog-item-image" src="img\img\photo-6.jpg" width="220" height="165" alt="Набор для бритья «Baxter of California»">
        </a>
        <p class="catalog-item-price">
          <b>3 900 ₽</b>
          <button class="button" type="button">Купить</button>
